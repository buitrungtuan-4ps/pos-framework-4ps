...
export function CatalogMenus() {
  ...
  // Memoized getters for active items, sections, and currency options to prevent O(N) array filtering
  // and sorting re-evaluations on every template render / signal dependency access.
