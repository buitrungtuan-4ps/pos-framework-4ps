...
| state | settle | void | reduce | split | merge |
|---|---|---|---|---|---|
| `BILL_STATE_OPEN` | `BILL_STATE_SETTLED` | `BILL_STATE_VOIDED` | `BILL_STATE_OPEN` | `BILL_STATE_SPLIT` | `BILL_STATE_MERGED` |
| `BILL_STATE_SETTLED` *(terminal)* | · | · | · | · | · |
| `BILL_STATE_VOIDED` *(terminal)* | · | · | · | · | · |
| `BILL_STATE_SPLIT` *(terminal)* | · | · | · | · | · |
| `BILL_STATE_MERGED` *(terminal)* | · | · | · | · | · |
